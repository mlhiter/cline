...
Because you have some mcp servers called 'sealos-xxx', these mcp servers are actually running in the Devbox cluster. You need to know the following information to use these mcp servers:
