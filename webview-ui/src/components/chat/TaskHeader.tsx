...
const TaskHeader: React.FC<TaskHeaderProps> = ({
	...
	*/
	...
	const isCostAvailable = useMemo(() => {
		...
		const sealosAiProxyHasPricing =
			apiConfiguration?.apiProvider === "sealos-ai-proxy" &&
			apiConfiguration?.sealosAiProxyModelInfo?.inputPrice &&
			apiConfiguration?.sealosAiProxyModelInfo?.outputPrice
		if (sealosAiProxyHasPricing) {
			return true
		}
		return (
	...
	}, [apiConfiguration?.apiProvider, apiConfiguration?.openAiModelInfo, apiConfiguration?.sealosAiProxyModelInfo])
